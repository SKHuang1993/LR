...
export default class ChatRoom extends React.Component {
    ...
    renderNav = ()=>{      return(          <YQFNavBar             titleStyle={{ width: FLEXBOX.width * 0.6 }}                title={this.store.conversation.Name}                 navigator={this.props.navigator}                leftIcon={'0xe183'}                rightIcon={'0xe131'}  
                                                                   OnLeftClick={()=>{                   if(Chat.obj.Source == '我去过'){                          this.props.navigator.pop();                      }               }}  
                                                                   onRightClick={()=>{       
                                                                       this.props.navigator.push({     
